...
const importConfigBtn = document.getElementById('importConfigBtn');
	...
	let accuracyQueryKey='',accuracyLivePayload=null,accuracyImportedMode=false,accuracyImportedLabel='',accuracyScopeSyncing=false;
